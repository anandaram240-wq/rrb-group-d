        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 flex flex-col p-6 overflow-y-auto">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[10px] text-on-surface-variant font-medium">{q.subject} › {q.topic} › {q.sub_topic}</span>
            </div>

            <p className="text-lg font-medium text-on-surface mb-6 leading-relaxed">{q.question}</p>
            ...
            {q.solution && (
              <div className="p-4 bg-primary/5 rounded-xl border border-primary/10 mb-6">
                <p className="text-xs font-bold text-primary mb-2">Solution</p>
                <p className="text-sm text-on-surface leading-relaxed">{q.solution}</p>
              </div>
            )}
    ...
    <div className="fixed inset-0 z-50 bg-surface flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col p-6 overflow-y-auto">
          ...
          <div className="text-lg text-on-surface mb-8 max-w-3xl leading-relaxed">{q.question}</div>
